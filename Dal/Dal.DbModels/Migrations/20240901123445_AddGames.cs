        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameEndTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    WinnerId = table.Column<int>(type: "integer", nullable: true),
                    MaxPointsCount = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
